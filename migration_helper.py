...
CATEGORIES_THEMES = {
    ...
    "Общественное питание": ["Кондитер", "Обслуживание", "Повар"],
    "Одежда": ["Модельер, дизайнер", "Пошив, работа с тканями."],
    "Природа": [
    ...
    "Спорт": ["Консультирование", "Тренер, инструктор"],
    "Финансы": [
        "Бухгалтерия",
        "Консультирование",
        "Страховые услуги",
    ...
    "Фото, видео": ["Фотоателье", "Издательские услуги", "Фотограф", "Художник"],
    "Юристы": ["Консультирование", "Юридические услуги"],
}
        ...
        with connection.cursor() as cursor:
            ...
            for cat_name, themes in CATEGORIES_THEMES.items():
                ...
                for theme_name in themes:
                    cursor.execute(
                        "INSERT INTO themes (name, category_id) VALUES (%s, %s)",
                        (theme_name, cat_id),
                    )
