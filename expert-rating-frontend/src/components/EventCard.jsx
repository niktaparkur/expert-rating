    ...
    return (
        <Card mode="shadow">
            ...
            <Div>
                ...
                <InfoRow header="Дата">{new Date(event.event_date + "Z").toLocaleString('ru-RU', {
                    year: 'numeric', month: 'long', day: 'numeric', hour: '2-digit', minute: '2-digit'
                })}</InfoRow>
                {event.status === 'approved' && <InfoRow header="Проголосовало">{event.votes_count} (👍{event.trust_count} / 👎{event.distrust_count})</InfoRow>}
            </Div>
