...
const exampleExperts = [
  ...
  },
  {
    ...
    topics: ["Психолог", "Консультирование"],
    show_community_rating: true,
    stats: { expert: 88, community: 81 },
  },
  {
    vk_id: 3,
    first_name: "Алексей",
    ...
    topics: ["Маркетинг", "SMM"],
    show_community_rating: false,
    stats: { expert: 85, community: 79 },
  },
  {
    vk_id: 4,
    first_name: "Елена",
    last_name: "Козлова",
    photo_url: "https://avatar.iran.liara.run/public/13",
    topics: ["Дизайн", "UX/UI"],
    show_community_rating: true,
    stats: { expert: 82, community: 88 },
  },
];
...
export const SingleCardGrid: Story = {
  args: {
    size: "l",
    children: (
      <ExpertCard expert={exampleExperts[0]} topPosition={1} onClick={fn()} />
    ),
  },
  parameters: {
    // @ts-ignore
