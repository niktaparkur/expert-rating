...
import {ModalPage, ModalPageHeader, Group, Header, SimpleCell, RichCell, Avatar} from '@vkontakte/vkui';
...
export const AfishaEventModal = ({id, event, onClose}: AfishaEventModalProps) => {
    ...
    return (
        <ModalPage id={id} onClose={onClose} header={<ModalPageHeader>Детали мероприятия</ModalPageHeader>}
                   settlingHeight={100}>
            <Group>
