...
export const ActiveWithExpiry: Story = {
    ...
    args: {
        promoCode: {id: 1, code: 'SALE25', discount_percent: 25, is_active: true, expires_at: futureDate.toISOString()},
    },
};
...
export const ActivePermanent: Story = {
    ...
    args: {
        promoCode: {id: 2, code: 'WELCOME10', discount_percent: 10, is_active: true, expires_at: undefined},
    },
};
