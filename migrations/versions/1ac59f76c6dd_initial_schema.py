...
Revision ID: 1ac59f76c6dd
Revises:
Create Date: 2025-10-07 16:15:30.580118
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "show_community_rating", sa.Boolean(), server_default="1", nullable=False
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["expert_id"], ["ExpertProfiles.user_vk_id"], ondelete="CASCADE"
        ),
        sa.PrimaryKeyConstraint("id"),
...
def downgrade() -> None:
    ...
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_table("Votes")
    op.drop_table("ExpertSelectedThemes")
